...
public class Scheduler {
	...
	public Scheduler(Machine[] machineArray) {
		machines = machineArray;		// NullPointerException eftersom man inte ändrar attributet machines utan man skapar en lokal variabel med samma namn
	}
	
	/* Returnerar den maskin som har minst att göra. */
	private Machine machineWithLeastToDo() {		// Går att ersätta med en prioritetskö
	...
	public void makeSchedule(List<Job> jobs) {
		...
		tempJobList.sort((j1, j2) -> j2.getTime() - j1.getTime());		// lambdauttrycket var felvänt
	...
	public void printSchedule() {
		for (int i = 0; i < machines.length; i++) {  // ArrayIndexOutOfBoundsException eftersom man har ett inklusivt logiskt uttryck
